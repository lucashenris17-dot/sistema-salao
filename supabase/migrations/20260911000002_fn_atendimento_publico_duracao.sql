-- =============================================================
-- Adicionar duracao_estimada_min ao retorno da função pública
-- Migration: 20260911000002_fn_atendimento_publico_duracao
-- =============================================================

DROP FUNCTION IF EXISTS public.fn_buscar_atendimento_publico(text);

CREATE FUNCTION public.fn_buscar_atendimento_publico(p_token text)
RETURNS TABLE (
  atendimento_id uuid,
...
BEGIN
  ...
  SELECT
    ...
    a.pausado_desde,
    a.criado_em,
    p.duracao_estimada_min AS duracao_estimada_min
